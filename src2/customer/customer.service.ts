...
export class CustomerService {
    ...
    async updateProfilePicture(myobj: CustomerEntity)
    {
        return await this.customerRepo.update(myobj.filename,myobj);
    }
    ...
    // async addToCart(cart: CartEntity): Promise<CartEntity> {
    //     const res = await this.productRepo.findOneBy({productId:cart.productId});
    //     if(res)
    //     {
