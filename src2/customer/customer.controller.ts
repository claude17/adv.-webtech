import { Body, Controller, Get, Param, Post, Query, UsePipes,Res, ValidationPipe, HttpException, HttpStatus,Session,UploadedFile,UseInterceptors, UseGuards, Put, Delete, NotFoundException } from "@nestjs/common";
...
export class CustomerController{
    ...
    @UsePipes(new ValidationPipe)
    async updateProfilePicture(@Body() myobj: CustomerEntity, @UploadedFile() myfile: Express.Multer.File) {
        myobj.filename = myfile.filename;
        return this.customerService.updateProfilePicture(myobj);
    }
